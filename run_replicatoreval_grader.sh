...
CIRCUIT_PROMPTS=("prompts/ioi_l2/replicator_evaluator.txt" "prompts/ioi_l2/grader.txt")
...
run_circuit_task() {
    ...
    stdbuf -oL -eL env PYTHONUNBUFFERED=1 SCRIBE_BENCHMARK_RUN_DIR="$RUN_DIR" timeout 2300 \
        scribe "$provider" > "$RUN_DIR/logs/${prompt_name}_${provider}.log" 2>&1
...
echo "✔ All evaluations complete! Results saved to $RUN_DIR/"
echo "▶ Run summary:"
